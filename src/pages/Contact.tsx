...
const Contact = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-8">Contact Me</h1>
      
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-xl font-semibold mb-6 dark:text-white">Contact Information</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-600 dark:text-gray-300">john@example.com</span>
            </div>
          ...
          <div className="mt-8">
            <h3 className="text-lg font-semibold mb-4 dark:text-white">Social Links</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-xl font-semibold mb-6 dark:text-white">Send a Message</h2>
