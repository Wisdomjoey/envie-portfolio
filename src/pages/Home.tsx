...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">Rejoice Modupe Obamah</h1>
      <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">UI/UX Designer</p>
